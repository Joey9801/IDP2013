...
int main ()
{
    ...
    while((status.task_time.read()<(1000*60*5))&(status.parcels_delivered<8)) //Spend 5 minutes on the task before quitting
    {
        set_intent();
